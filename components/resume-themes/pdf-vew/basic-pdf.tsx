...
const BasicPDF = ({portfolio}:props) => (
    <Document>
      <Page style={{ padding: '45px', height: "100%", width: "100%" }} size={"A4"} wrap>
        <Text style={{ marginHorizontal: "auto", textTransform: "capitalize",fontFamily:'Times-Roman'}}>
        ...
        >
          <Text style={{ fontSize: "10px", color: "#555555",fontFamily:'Times-Roman' }}>
            {portfolio.country}
          </Text>
        ...
        <View>
          ...
          <Text
            style={{ fontSize: "10px", marginTop: "2px", color: "#555555",fontFamily:'Times-Roman' }}
          >
            {portfolio.bio}
          </Text>
        </View>
