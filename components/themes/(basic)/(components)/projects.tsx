...
import 'swiper/css/scrollbar';import { Image as PImage, Project } from "@prisma/client";
      ...
      >
        {projects.map((project) => (
          <SwiperSlide key={project.id} className=" pb-28">
            <div
              className={`w-full sm:w-[450px] md:w-[700px] mx-auto group aspect-video rounded-lg overflow-hidden relative grayscale-[5] hover:grayscale-0 transition duration-300 cursor-pointer  `}
            >
              <div className="absolute top-0  aspect-video w-full md:w-[300px] 
