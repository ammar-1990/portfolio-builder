...
const ExperienceComponent = ({ experience, preview,readOnly }: Props) => {
  ...
  return (
    <div className=" border rounded-2xl overflow-hidden h-full col-span-1  transition flex flex-col relative group active:scale-[0.99] p-4 bg-white">
